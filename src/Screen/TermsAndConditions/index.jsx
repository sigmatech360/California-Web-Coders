...
import bannerBgImage from "../../Assets/termsAndCondition-banner-bg.png";
...
//     paragraphs: [
//       "All content on this site, including text, graphics, logos, button icons, images, digital downloads, data compilations, and software, is the property of this Company or its content suppliers and is protected by international copyright laws. The compilation of all content on this site is the exclusive property of this Company and is protected by international copyright laws. Any software used on this site is the property of this Company or its software suppliers and is protected by international copyright laws.",
//       "The trademark names used within our sites belong to their respective companies or subsidiaries. They cannot be used with any product or service not affiliated with that Company.",
//     ],
//   },
//   {
//     title: "Copyright Complaints",
//     paragraphs: [
//       "The Company and its affiliates respect the intellectual property rights of others. If any visitor to the site believes that their work has been copied in a way that constitutes copyright infringement, please follow our Notice and Procedure for Making Claims of Copyright Violation.",
//       "We take copyright complaints seriously and will address any reported violations promptly and appropriately. Your cooperation in ensuring the protection of intellectual property is greatly appreciated.",
//     ],
//   },
//   {
//     title: "Refund Policy",
...
//       "Approval of Primary Design Concept: Once you have approved the primary design concept, the refund policy will no longer be applicable.",
//       "Revisions Requested: If you have requested revisions to the design, a refund will not be provided.",
//       "Cancellation Unrelated to the Company: If the cancellation is due to reasons unrelated to the Company, a refund will not be issued.",
//       "No Contact for More than 2 Weeks: Failure to contact the Company for more than two weeks during the project may result in the forfeiture of the refund.",
//       "Violation of Company Policies: Refunds will not be granted if our company policies are violated.",
//       "Approach to Other Companies or Designers: A refund will not be entertained if other companies or designers already approached the project.",
//       "Inadequate Creative Brief: A refund will only be processed if the provided creative brief has the required information.",
//       "Complete Design Change Demanded: Requests for a complete design change after the project has started will not be eligible for a refund.",
//       "Exceeding ‘Request for Refund’ Time Span: Refund requests submitted beyond the specified ‘request for refund’ time span will not be considered.",
//       "Non-Refundable Services: Certain services, such as Social Media, SEO, Domain Registration, and Web Hosting, are not entitled to refunds under any circumstances.",
//       "Website Development Approvals: Once you have approved the website design and it is sent for development, refunds will not be entertained.",
//       "Money-Back Guarantee: If the client rejects the initial designs, a money-back guarantee will apply. However, if additional design concepts or modifications are",
//       "requested after this point, 33% of the total billing amount will be deducted for incurred costs, including processing and management charges.",
...
//     title: "Account Area",
//     paragraphs: [
//       "Our Account Area provides a convenient platform for communication. You are responsible for regularly checking the account area for any queries, concerns, or additional instructions from the designer. Failure to utilize the Account Area frequently will not be considered sufficient grounds for a refund. Should you require assistance using this feature, our customer support team can help anytime.",
//     ],
//   },
//   {
//     title: "Delivery Policy",
//     paragraphs: [
//       "Upon confirmation of your order, the complete package will be delivered to the designated account on the specified date mentioned in the Order Confirmation. Additionally, a confirmation email will be sent to you. The turnaround time will align with your chosen package, with the minimum processing time being 2 business days.",
//       "Don’t hesitate to contact our customer support team for urgent orders.",
//     ],
//   },
//   {
//     title: "Revision Policy",
//     paragraphs: [
//       "The number of revisions available is determined by the package you select, and you may request revisions as specified in your package details. We are committed to delivering top-notch service and will continue revising until your needs are met. You will not incur any additional charges if the design concepts remain unchanged. Revised designs will be provided within 48 hours.",
//       "Please note that any changes or revisions requested after the finalization of logo designs will be treated as a new order and billed separately.",
//     ],
//   },
//   {
...
//     paragraphs: [
//       "Our customer support team is available 24/7 to address all your concerns and queries. You can count on our dedicated team to provide timely and comprehensive responses to your inquiries, no matter the time or day. Your satisfaction is our top priority, and we are here to assist you every step of the way.",
//     ],
//   },
//   {
...
//     ],
//     paragraphsAfterList: [
//       "We take copyright violations seriously and will promptly address any reported issues in compliance with applicable laws and regulations. Your cooperation in helping us maintain a respectful and law-abiding online environment is highly appreciated.",
//     ],
//   },
//   {
//     title: "Applicable Law",
//     paragraphs: [
//       "Your use of the service requires strict compliance with all applicable laws, including any relevant export controls. Additionally, you must adhere to any further limitations or guidelines outlined in written or on-screen notices from nywebexperts.com. We value ethical conduct and responsible usage of our services and expect all users to respect and abide by the law.",
//     ],
//   },
//   {
//     title: "Disputes",
//     paragraphs: [
//       "If any dispute arises from your visit to our website or the services you purchase through our site, such disputes shall be submitted to our dedicated Dispute Handling Department. We are committed to resolving issues fairly and transparently, ensuring customer satisfaction.",
//       "The legal proceedings will be conducted in the Courts of Houston, TX, for disputes that lead to court arbitration. We uphold a transparent and efficient dispute resolution process and aim to resolve conflicts amicably and equitably.",
//     ],
//   },
//   {
...
//   },
//   {
//     title: "Means of Reaching the Company:",
//     paragraphs: [
//       "To ensure smooth communication from the point of purchase to the completion of your order, we offer multiple means to contact us. You can reach us through the following methods:",
//     ],
//     list: [
...
//     subTite: "No Obligation",
//     paragraphs: [
//       "We provide our Notification Services, such as email, free of charge, and clients are not obligated to make any purchases. Enjoy the benefits of staying informed without any financial commitments.",
//     ],
//   },
//   {
//     subTite: "Unsubscribing",
//     paragraphs: [
//       "Clients can unsubscribe or modify their subscription to our Notification Services. Visit the My Account section on our site to manage subscriptions easily online.",
//     ],
//   },
//   {
//     subTite: "Updates",
//     paragraphs: [
//       "As our valued customer, you will occasionally receive email updates about important functionality changes to our website, new services, and special offers that our Client Services team believes you find valuable. However, if you wish not to receive these updates, you can adjust your preferences by logging into the My Account section on our site.",
//     ],
//   },
//   {
//     subTite: "Note",
//     paragraphs: [
//       "We take cybercrime seriously and strictly prohibit using stolen credit cards on our platform. Any fraudulent activities will be promptly reported to Federal and State Agencies as we work diligently to combat cybercrime and ensure a secure online environment for all our clients. Your safety and trust are of utmost importance to us.",
//     ],
//   },
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="privacy-policy-content">
              <p>
                Before placing an order, California Web Coders urge all visitors
                to carefully read and familiarize themselves with our website’s
                terms and conditions. You acknowledge your understanding and
                agreement with these terms by proceeding with our services. Your
                satisfaction and compliance are paramount to us.
              </p>
              <ul>
              ...
              <p>
                Your decision to visit our homepage is voluntary, and we respect
                your privacy. Any disputes concerning privacy will be governed
                by this Notice and our Conditions of Use, which include
                limitations on damages, dispute arbitration, and applicable
                state laws. Should you have any concerns regarding our Privacy
                Policy, please don’t hesitate to contact our customer services,
                which are dedicated to serving you with utmost satisfaction.
              </p>
              <p>
                Kindly be informed that our policies are subject to change at
                any time. Thus, we recommend you review our policy each time you
                visit our site for purchase.
              </p>
              <p>
                To improve our services and better understand our clients, we
                collect navigational information, such as the areas of our
                website most visited and technical efficiencies like connection
                and download times. This data enables us to enhance the quality
                of our site and address any areas that may need improvement.
              </p>
              <p>
                ...
                “Contents”), are copyrighted, trademarks, trade dress, or other
              ...
              <p>
                ...
                personal use only. However, no right, title, or interest in any
                downloaded materials or software is transferred to you due to
                such downloading or copying. It is strictly prohibited to
              ...
              <p>
                We value your compliance with these terms as they help maintain
                the integrity of our content and ensure a positive experience
                for all visitors to californiawebcoders.com. Our dedicated
                customer support team is always ready to assist you with any
                further queries or require assistance.
              </p>
              <h3>Testimonials</h3>
              <p>
                Any comments, feedback, postcards, suggestions, ideas, and other
                submissions disclosed, submitted, or offered to California Web
                Coders on or in connection with your use of this site
                (collectively, the “Comments”) shall remain the Company’s
                exclusive property. The Company shall have unrestricted rights,
                titles, and interests in the Comments, and it is not obliged to:
              </p>
              <ul>
              ...
              <p>
                ...
                communicate with our Company electronically. The receipt of our
                communications electronically is involuntary. California Web
                Coders will communicate with the client via email or by posting
                notices on this site. Therefore, the client agrees that all
                agreements, notices, disclosures, and relevant communications
                satisfy all legal requirements and hold the same value as any
                written statement.
              </p>
              <h3>Copyright/Trademarks</h3>
              <p>
                All content on this site, including text, graphics, logos,
                button icons, images, digital downloads, data compilations, and
                software, is the property of this Company or its content
                suppliers and is protected by international copyright laws. The
                compilation of all content on this site is the exclusive
              ...
              <p>
                ...
                rights of others. If any visitor to the site believes that their
                work has been copied in a way that constitutes copyright
                infringement, please follow our Notice and Procedure for Making
                Claims of Copyright Violation.
              </p>
              <p>
                We take copyright complaints seriously and will address any
                reported violations promptly and appropriately. Your cooperation
                in ensuring the protection of intellectual property is greatly
                appreciated.
              </p>
              <h2>Refund Policy</h2>
              <p>
              ...
              <ul>
                <li>
                  ...
                  not applicable for special packages that are explicitly stated
                  as non-refundable
                </li>
                <li>
                  <strong>Approval of Primary Design Concept:</strong> Once you
                  have approved the primary design concept, the refund policy
                ...
                <li>
                  <strong>Cancellation Unrelated to the Company:</strong> If the
                  cancellation is due to reasons unrelated to the Company, a
                  refund will not be issued.
                </li>
                <li>
                  <strong>No Contact for More than 2 Weeks:</strong> Failure to
                  contact the Company for more than two weeks during the project
                ...
                <li>
                  ...
                  refund will not be entertained if other companies or designers
                  already approached the project.
                </li>
                <li>
                  <strong>Inadequate Creative Brief:</strong> A refund will only
                  be processed if the provided creative brief has the required
                  information.
                </li>
                <li>
                  <strong>Complete Design Change Demanded:</strong> Requests for
                  a complete design change after the project has started will
                ...
                <li>
                  ...
                  Hosting, are not entitled to refunds under any circumstances.
                </li>
                <li>
                  <strong>Website Development Approvals:</strong> Once you have
                  approved the website design and it is sent for development,
                ...
                <li>
                  ...
                  will be deducted for incurred costs, including processing and
                  management charges.
                </li>
                <li>
                  <strong>Change of Mind:</strong> Refund is not applicable on
                  the change of mind or any concern that is not related to work
                  ethics.
                </li>
              </ul>
              <p>
              ...
              <p>
                Don’t hesitate to contact our customer support team for further
                clarification or to initiate a refund process. We value your
                understanding and cooperation in adhering to our refund policy.
              </p>
              <h2>
                To proceed with your refund request, kindly follow these steps:
              </h2>
              ...
              <ul>
                ...
                <li>
                  We will promptly respond and begin the necessary analysis upon
                  receiving your refund request. Once completed, the refund
                  process will be initiated.
                </li>
                <li>
                  Please be aware that after the refund is issued, you will no
                  longer retain any rights to the designs or materials submitted
                  by Californiawebcoders.com. The relevant information will be
                  submitted to the Government Copyright Agencies to ensure
              ...
              <p>
                ...
                requirements and exceeding your expectations. Our designers take
                pride in crafting well-researched and finely crafted designs to
                ensure your satisfaction.
              </p>
              <p>
                100% SATISFACTION GUARANTEE: Our commitment to your satisfaction
                is unwavering. With our unlimited revisions policy, we aim to
                ensure you are 100% satisfied with the final product.
              </p>
              <p>
                We strive to surpass your expectations and will only rest once
                you are completely content with your design. The number of
                revisions available will be according to your package selection.
              </p>
              <h3>Account Area</h3>
              <p>
                ...
                Area frequently will not be considered sufficient grounds for a
                refund. Should you require assistance using this feature, our
                customer support team can help anytime.
              </p>
              ...
              <p>
                ...
                confirmation email will be sent to you. The turnaround time will
                align with your chosen package, with the minimum processing time
                being 2 business days.
              </p>
              <p>
              ...
              <p>
                ...
                service and will continue revising until your needs are met. You
                will not incur any additional charges if the design concepts
                remain unchanged. Revised designs will be provided within 48
                hours.
              </p>
              <p>
                Please note that any changes or revisions requested after the
                finalization of logo designs will be treated as a new order and
                billed separately.
              </p>
              ...
              <p>
                ...
                to ensure that you will be promptly provided with the exact file
                you need in case of misplaced orders. Our commitment to
                maintaining accurate and organized records is part of our
                dedication to delivering a seamless and efficient experience to
                our valued clients.
              </p>
              <h3>Customer Support</h3>
              <p>
                Our customer support team is available 24/7 to address all your
                concerns and queries. You can count on our dedicated team to
                provide timely and comprehensive responses to your inquiries, no
                matter the time or day. Your satisfaction is our top priority,
                and we are here to assist you every step of the way.
              </p>
              <h3>Communication Policy</h3>
              <p>
                For effective communication, we urge you to exclusively use the
              ...
              <p>
                We value the trust you place in us and take full responsibility
                for all information provided through our official domains. Your
                privacy and data security are of utmost importance, and we
                maintain strict measures to safeguard the confidentiality of
                your information.
              </p>
              <h2>
                Notice and Procedure for Making Claims of Copyright Violation
              ...
              <p>
                ...
                rights of others. If you believe that your work has been copied
                in a way that constitutes a copyright violation, please follow
              ...
              <ul>
                ...
                <li>
                  Specify the location on the site where the material you claim
                  is copied from can be found, including any relevant ID number.
                </li>
                <li>
                  Include your address, telephone number, and email address for
                  communication purposes.
                </li>
                <li>
                  State in good faith that the disputed use is not authorized by
              ...
              <p>
                We take copyright violations seriously and will promptly address
                any reported issues in compliance with applicable laws and
                regulations. Your cooperation in helping us maintain a
              ...
              <p>
                ...
                committed to resolving issues fairly and transparently, ensuring
              ...
              <p>
                ...
                unenforceable for any reason. In that case, such provision shall
                be considered severable and shall not impact the validity and
                enforceability of the remaining conditions.
              </p>
              <h3>Means of Reaching the Company:</h3>
              <p>
                To ensure smooth communication from the point of purchase to the
                completion of your order, we offer multiple means to contact us.
              ...
              <p>
                Please note that any other means of communication outside these
                specified methods are not considered valid for contacting
                California Web Coders. We appreciate your cooperation and
                understanding in utilizing the designated channels for effective
              ...
              <p>
                ...
                Notification Services. Visit the My Account section on our site
                to manage subscriptions easily online.
              </p>
              <h3>Updates</h3>
              <p>
                ...
                believes you find valuable. However, if you wish not to receive
                these updates, you can adjust your preferences by logging into
                the My Account section on our site.
              </p>
              <h3>Note</h3>
              <p>
                We take cybercrime seriously and strictly prohibit using stolen
                credit cards on our platform. Any fraudulent activities will be
                promptly reported to Federal and State Agencies as we work
                diligently to combat cybercrime and ensure a secure online
                environment for all our clients. Your safety and trust are of
