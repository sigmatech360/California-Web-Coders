...
const WebsiteRevamp = () => {
  ...
  return (
    <>
      <ReactHelmet
        title="Website Revamp Services | California Web Coders"
        description="Transform your outdated website into a modern, responsive, and high-converting platform with our expert website revamp services."
        keywords="website revamp, redesign website, modern website design, website upgrade"
        baseUrl="https://californiawebcoders.com/website-revamp"
      />
      <Layout>
        <ServiceBanner
