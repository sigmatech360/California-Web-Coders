  ...
  return (
    <>
      <ReactHelmet
        ...
        description="Custom WordPress websites built for performance, scalability, and SEO. From themes to plugins, we deliver full-scale WordPress solutions."
        keywords="WordPress development, custom WordPress themes, WordPress plugins, blog development"
        baseUrl="https://californiawebcoders.com/wordpress-development"
      />
      <Layout>
        <ServiceBanner
