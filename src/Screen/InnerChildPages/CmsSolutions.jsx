...
const CmsSolutions = () => {
  ...
  return (
    <>
      <ReactHelmet
        title="Custom CMS Solutions | California Web Coders"
        description="Streamline content management with powerful, scalable CMS solutions tailored to your business needs. Partner with California Web Coders for professional CMS development."
        keywords="CMS development, custom CMS, content management system, web solutions, business website"
        baseUrl="https://californiawebcoders.com/cms-solution"
      />
      <Layout>
        <ServiceBanner
