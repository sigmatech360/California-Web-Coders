  ...
  return (
    <>
      <ReactHelmet
        ...
        description="Beautiful, user-friendly Wix websites designed to showcase your brand and grow your online presence. Get custom Wix solutions today."
        keywords="Wix development, Wix website design, custom Wix website, drag-and-drop website"
        baseUrl="https://californiawebcoders.com/wix-development"
      />
      <Layout>
        <ServiceBanner
