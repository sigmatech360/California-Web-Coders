...
const SquarespaceDevelopment = () => {
  ...
  return (
    <>
      <ReactHelmet
        title="Squarespace Website Development | California Web Coders"
        description="Professional Squarespace websites tailored for businesses, portfolios, and eCommerce. Launch your online presence with Squarespace experts."
        keywords="Squarespace development, Squarespace design, custom Squarespace website"
        baseUrl="https://californiawebcoders.com/squarespace-development"
      />
      <Layout>
        <ServiceBanner
