...
const ECommerceDevelopment = () => {
  ...
  return (
    <>
      <ReactHelmet
        title="eCommerce Development Services | California Web Coders"
        description="Get high-performance eCommerce websites designed to maximize sales and enhance customer experience. Partner with us for scalable eCommerce solutions."
        keywords="eCommerce development, online store, shopping website, custom eCommerce solutions"
        baseUrl="https://californiawebcoders.com/eCommerce-development"
      />
      <Layout>
        <ServiceBanner
