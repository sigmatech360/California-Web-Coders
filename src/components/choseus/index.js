          ...
          <div className=" col-md-6 col-lg-3 mb-3">
            ...
            >
              <div className="card-body">
                ...
                >
                  <img src={smart} className="img-fluid" alt="Creative Solutions" />
                </div>
            ...
            >
              <div className="card-body">
                <div
                  ...
                  // style={{ width: "60px", height: "60px" }}
                >
                  <img src={Professiona} className="img-fluid" alt="User-friendly Experience" />
                </div>
            ...
            >
              <div className="card-body">
                <div
                  ...
                  // style={{ width: "60px", height: "60px" }}
                >
                  <img src={Certified} className="img-fluid" alt="CPerformance Driven" />
                </div>
            ...
            >
              <div className="card-body">
                <div
                  ...
                  // style={{ width: "60px", height: "60px" }}
                >
                  <img src={Premium} className="img-fluid" alt="24/7 Customer Service" />
                </div>
